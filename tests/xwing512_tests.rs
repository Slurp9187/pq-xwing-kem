//! Unit tests for xwing512.

use pq_xwing_kem::xwing512::{
    generate_keypair, Ciphertext, EncapsulationKey, XWING512_CIPHERTEXT_SIZE,
...
fn test_generate_keypair() {
    ...
    assert_eq!(pk.to_bytes().len(), XWING512_ENCAPSULATION_KEY_SIZE);
}
...
fn test_encapsulation_decapsulation_roundtrip() {
    ...
    assert_eq!(ct.to_bytes().len(), XWING512_CIPHERTEXT_SIZE);
}

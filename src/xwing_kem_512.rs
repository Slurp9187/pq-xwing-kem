...
pub const CIPHERTEXT_SIZE: usize = XWING512_CT_SIZE + X25519_KEY_SIZE;
...
impl EncapsulationKey {
    ...
    pub fn encapsulate<R: rand_core::RngCore + rand_core::CryptoRng>(
        ...
        let pk_m = MlKem512PublicKey::from(self.pk_m);
...
impl DecapsulationKey {
    ...
    pub fn decapsulate(&self, ct: &Ciphertext) -> SharedSecret {
        ...
        // kp.private_key() returns &MlKem512PrivateKey
        let sk_m = kp.private_key();
        let ct_m = MlKem512Ciphertext::from(ct.ct_m);
...
fn expand_seed(seed: &[u8; MASTER_SEED_SIZE]) -> (MlKem512KeyPair, [u8; 32]) {
    ...
    // Draft-09: ML-KEM-512.KeyGen_internal(expanded[0:32], expanded[32:64])
